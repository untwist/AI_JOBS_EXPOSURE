...
8. **Website** (`docs/index.html`) — Interactive treemap where area = employment and color = AI exposure. You can toggle color by **LLM (0–10)**, **Anthropic (%)**, or **AIOE (Felten)**. A link to **Exposure by geography** opens the county map.
